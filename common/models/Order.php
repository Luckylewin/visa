...
class Order extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['pid', 'order_date', 'customer_id', 'combo_id', 'custom_servicer_id', 'transactor_id', 'transactor_name', 'product_id', 'balance_sum', 'flushphoto_order', 'carrier_order', 'collect_date', 'deliver_date', 'entry_date', 'putsign_date', 'operator', 'back_address', 'back_addressee', 'back_telphone', 'delivergood_date', 'deliver_order', 'delivercompany_id', 'remark', 'receipt_date', 'pay_date'], 'required'],
            [['pid', 'customer_id', 'combo_id', 'custom_servicer_id', 'transactor_id', 'product_id', 'total_person', 'delivercompany_id'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'pid' => '产品id',
            'order_classify' => '1网店2直客3同业',
            'order_type' => '1正常2加急3特急',
            'order_date' => '订单日期',
            'customer_id' => '客户id',
            'combo_id' => '套餐id',
            ...
            'deliver_order' => '订单编号',
            'delivercompany_id' => '订单公司ID',
            'remark' => '备注',
            'receipt_date' => '收款日期',
            'pay_date' => '支付日期',
            'audit_status' => '1审核中2审核未通过3审核通过',
        ];
    }
}
