...
<head>
    ...
    <link href="/statics/themes/newadmin/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
                            ...
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/statics/themes/newadmin/img/a7.jpg">
                                    </a>
                ...
                <div id="tab-2" class="tab-pane">
                    ...
                    <div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/statics/themes/newadmin/img/a1.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/statics/themes/newadmin/img/a2.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/statics/themes/newadmin/img/a3.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/statics/themes/newadmin/img/a4.jpg">
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/statics/themes/newadmin/img/a8.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="/statics/themes/newadmin/img/a7.jpg">
                                </div>
                                <div class="media-body">
...
<script src="/statics/themes/newadmin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="/statics/themes/newadmin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="/statics/themes/newadmin/js/plugins/layer/layer.min.js"></script>

<!-- 自定义js -->
<script src="/statics/themes/newadmin/js/hplus.js?v=4.1.0"></script>
<script type="text/javascript" src="/statics/themes/newadmin/js/contabs.js"></script>

<!-- 第三方插件 -->
<script src="/statics/themes/newadmin/js/plugins/pace/pace.min.js"></script>
